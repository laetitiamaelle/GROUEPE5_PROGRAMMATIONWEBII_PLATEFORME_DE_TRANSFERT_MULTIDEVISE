        ...
        <form className="mt-8 space-y-5" onSubmit={onSubmit}>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-cash-bg px-3 py-2.5 focus-within:border-accent/50">
              ...
              <input className="w-full border-0 bg-transparent text-sm text-white outline-none" type="password" autoComplete="current-password" value={password} onChange={(e) => setPassword(e.target.value)} required />
            </div>
          </div>
